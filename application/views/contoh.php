...
<body>
	<p><strong>Kalkulatro Zakat</strong></p>
	<p>Keterangan : </p>
	<ul>
		<li>Masukkanlah Data ( Nominal) Kedalam kotak yang tersedia di samping kanan pada setiap keterangan</li>
		<li>Untuk Mendapatkan<strong> Jumlah Zakat </strong>, anda harus Memasukkan nominal pada baris z. <strong>Harga Emas Murni Saat ini per Gram</strong> dan Tekan Enter</li>
